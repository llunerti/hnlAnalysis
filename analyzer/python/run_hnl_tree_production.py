...
inputFiles_str = ",".join(inputFileName_list)

cfgDir = "/afs/cern.ch/work/l/llunerti/private/CMSSW_10_2_27/src/hnlAnalysis/analyzer/python/"
mc_cfg = "ConfFile_cfg_mini_MC.py"
data_cfg = "ConfFile_cfg_mini_Run2018D.py"
cfgFile = str()

if category == "data":
    cfgFile = os.path.join(cfgDir,data_cfg)
else:
    cfgFile = os.path.join(cfgDir,mc_cfg)

command = "cmsRun {} inputFiles={} outputFile={} maxEvents={}".format(cfgFile,inputFiles_str,outputFileName,max_events)
