...
options.outputFile = 'DsToPhiPi_PhiToMuMu_prompt_analyzer_'+options.inputFiles[0].split("/")[4]+'_tree.root'
options.maxEvents = -1
...
process.demo = cms.EDAnalyzer('DsToPhiPi_PhiToMuMu_prompt_miniAOD',
